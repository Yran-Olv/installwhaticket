...
```bash
sudo apt install -y git && git clone https://github.com/Yran-Olv/installwhaticket.git instalador && sudo chmod -R 777 instalador  && cd instalador  && sudo ./instalar_primaria
```
===================================================
